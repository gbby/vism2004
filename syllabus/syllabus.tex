...
Week 1. January 6 \\
Lecture 1 - History \\
%History of Communications Technology, Ideologies of Technology, Technodeterminism \\
Readings: \\
%wizards at night; abbate; http://www.rand.org/about/history/baran.html
Questions: Where did the internet come from? Why did it emerge? What purpose(s) did it serve?
%Evocative Objects: \\
...
% more history, what is information?
%Cybernetics, Networks, Flows of Information, Network Society, representation \\
...
\newcommand{\CourseAss}{
\textbf{Web Portfolio Assignments:} \\
...
\begin{flushleft}
	\begin{tabular}{c c}
		...
		%& \textbf{Assignment of Letter Grades} \\
		\GradeDist
		%&
		%\LetterAssign
	\end{tabular}
